...
import {addItemCount, deleteItem, removeItemsCount} from "../../Redux/store-reducer";
...
export default connect(mapStateToProps, {addItemCount, removeItemsCount, deleteItem})(CartContainer)
